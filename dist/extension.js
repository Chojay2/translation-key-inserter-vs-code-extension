...
const handleKeyValue_1 = __importDefault(__webpack_require__(4));
function activate(context) {
    const translationFormat = [
        { project: 'react', start: "{t('", end: "')}" },
        { project: 'angular', start: "{{'", end: "' | translate }}" },
    ];
    let disposable = vscode.commands.registerCommand('extension.translateText', async () => {
        ...
        (0, handleKeyValue_1.default)(transformedText, selectedText);
    });
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const gristService_1 = __webpack_require__(5);
...
const grist = new gristService_1.GristService(apiKey, gristURL);
// Usage example
const docId = 'm4iPTTkDkTyYSsxoSRBgQz';
const tableId = 'Talbu';
async function saveToGrist(transformedText, selectedText) {
    try {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GristService = void 0;
const axios_1 = __importDefault(__webpack_require__(6));
class GristService {
    apiKey;
    gristURL;
    constructor(apiKey, gristURL) {
        this.apiKey = apiKey;
        this.gristURL = gristURL;
    }
    async fetchRecords(docId, tableId) {
        try {
            const recordsResponse = await axios_1.default.get(`${this.gristURL}/docs/${docId}/tables/${tableId}/records`, {
                headers: {
    ...
    async writeTransformedText(docId, tableId, transformedText, selectedText) {
        try {
            const dataToWrite = {
                records: [
                    {
            ...
            await axios_1.default.post(`${this.gristURL}/docs/${docId}/tables/${tableId}/records`, dataToWrite, {
                headers: {
                    Authorization: `Bearer ${this.apiKey}`,
                },
            });
...
exports.GristService = GristService;
...
var asynckit = __webpack_require__(18);
var populate = __webpack_require__(28);
...
module.exports =
{
  ...
  serial        : __webpack_require__(26),
  serialOrdered : __webpack_require__(27)
};
...
var defer = __webpack_require__(22);
...
var serialOrdered = __webpack_require__(27);
